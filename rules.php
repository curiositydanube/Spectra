...
<head>
    <meta charset="UTF-8">
    <title>Spectra - Community Rules</title>
...
<body>
    ...
    <main style="padding: 15px;">
        <h2>Spectra Community Rules</h2>
        <ul style="line-height: 2;">
            <li><strong>Respect Others:</strong> No harassment, hate speech, or personal attacks.</li>
            <li><strong>Content Integrity:</strong> Do not upload malicious software, spam, or copyrighted material.</li>
            <li><strong>Appropriate Material:</strong> Keep all broadcasts and bulletins within PG-13 guidelines.</li>
            <li><strong>Admin Authority:</strong> Administrative decisions are final. Bypassing account bans will result in permanent termination.</li>
        </ul>
    </main>
